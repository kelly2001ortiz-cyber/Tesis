...
def calcular_areas_longitudinales_columna_x(n_var_x, n_var_y, d_long_general, d_long_esquina):
...
def calcular_respuesta_seccion(
    ...
    As_face_y, As_total = calcular_areas_longitudinales_columna_x(
        n_var_x=n_var_x,
        n_var_y=n_var_y,
...
def ejecutar_mc_asce_columnaX(datos_hormigon, datos_acero, datos_seccion, datos_asce):
