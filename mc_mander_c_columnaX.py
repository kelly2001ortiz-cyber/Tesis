...
def ejecutar_mc_mander_confinado_columnaX (datos_hormigon, datos_acero, datos_seccion, datos_fibras):
    ...
    NLy = int(float(datos_seccion.get("disenar_columna_ramalesX")))
    NLx = int(float(datos_seccion.get("disenar_columna_ramalesY")))
    Nb = (Nb1 - 2) * 2 + Nb2 * 2
